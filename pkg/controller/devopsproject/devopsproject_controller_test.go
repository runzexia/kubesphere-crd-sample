...
func TestReconcile(t *testing.T) {
	...
	instance := &devopsv1alpha2.DevOpsProject{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the DevOpsProject object and expect the Reconcile and Deployment to be created
